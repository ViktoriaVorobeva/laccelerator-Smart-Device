...
/* harmony import */ var _modules_breakpoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/breakpoints */ "./js/modules/breakpoints.js");
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scroll */ "./js/modules/scroll.js");
/* harmony import */ var _modules_about_company_show__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/about-company-show */ "./js/modules/about-company-show.js");
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_breakpoints__WEBPACK_IMPORTED_MODULE_3__["breakpointChecker"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_4__["getScrollForm"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_6__["initAccordions"])();
    if (accordionElement) {
      _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_6__["accordions"].closeAllAccordion(accordionElement);
    }
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_2__["Form"]();
    form.init();
    window.form = form;
    Object(_modules_about_company_show__WEBPACK_IMPORTED_MODULE_5__["breakpointShowChecker"])();
    Object(_modules_about_company_show__WEBPACK_IMPORTED_MODULE_5__["showMoreAbout"])();
  });
});
...
/***/ "./js/modules/about-company-show.js":
/*!******************************************!*\
  !*** ./js/modules/about-company-show.js ***!
  \******************************************/
/*! exports provided: showMoreAbout, breakpointShowChecker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showMoreAbout", function() { return showMoreAbout; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointShowChecker", function() { return breakpointShowChecker; });
var showMoreButton = document.querySelector('.about-company__button');
var showMoreText = document.querySelector('.about-company__more');
var showMoreTextAdd = document.querySelector('.about-company span');
var stylesShowMoreText = window.getComputedStyle(showMoreText);
var breakpoint = window.matchMedia('(max-width:767px)');
var showMoreAbout = function showMoreAbout() {
...
var breakpointShowChecker = function breakpointShowChecker() {
  if (breakpoint.matches) {
    showMoreTextAdd.style.display = 'none';
  } else {
    showMoreTextAdd.style.display = 'inline';
...
var breakpoint = window.matchMedia('(max-width:767px)');
var mainScreenButton = document.querySelector('.main-screen__link');
var catalogText = document.querySelector('.catalog h2');
...
/* harmony import */ var _sibmit_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sibmit-message */ "./js/modules/form-validate/sibmit-message.js");
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  sendData(function () {
    unblockSubmitButton();
    Object(_sibmit_message__WEBPACK_IMPORTED_MODULE_0__["showSuccessMessage"])();
  }, function () {
    unblockSubmitButton();
    Object(_sibmit_message__WEBPACK_IMPORTED_MODULE_0__["showErrorMessage"])();
...
/***/ "./js/modules/form-validate/sibmit-message.js":
/*!****************************************************!*\
  !*** ./js/modules/form-validate/sibmit-message.js ***!
  \****************************************************/
/*! exports provided: showErrorMessage, showSuccessMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var onMessageEscKeydown = function onMessageEscKeydown(evt) {
  if (isEscapeKey(evt)) {
    evt.preventDefault();
    closeMessage();
  }
...
function closeMessage() {
  var messageElement = document.querySelector('.error') || document.querySelector('.success');
...
/*!******************************!*\
  !*** ./js/modules/scroll.js ***!
  \******************************/
/*! exports provided: getScrollForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScrollForm", function() { return getScrollForm; });
var scrollSection = document.querySelector('#form');
var scrollButton = document.querySelector('.main-screen__link');
var getScrollForm = function getScrollForm() {

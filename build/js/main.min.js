...
/* harmony import */ var _modules_about_company_show__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-company-show */ "./js/modules/about-company-show.js");
/* harmony import */ var _modules_check_products__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/check-products */ "./js/modules/check-products.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_about_company_show__WEBPACK_IMPORTED_MODULE_4__["breakpointShowChecker"])();
    Object(_modules_about_company_show__WEBPACK_IMPORTED_MODULE_4__["showMoreAbout"])();
    Object(_modules_check_products__WEBPACK_IMPORTED_MODULE_5__["breakpointCatalogChecker"])();
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_6__["addAccordion"])();
  });
});
...
var addAccordion = function addAccordion() {
  accordionButtons.forEach(function (button) {
    return button.addEventListener('click', getAccordionShow);
  });
};
function getAccordionShow(evt) {
  var accordionShowElement = document.querySelector('.accordion--show');
...
/***/ "./js/modules/check-products.js":
/*!**************************************!*\
  !*** ./js/modules/check-products.js ***!
  \**************************************/
/*! exports provided: breakpointCatalogChecker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointCatalogChecker", function() { return breakpointCatalogChecker; });
var breakpoint = window.matchMedia('(max-width:767px)');
var catalogText = document.querySelector('.catalog__text');
var breakpointCatalogChecker = function breakpointCatalogChecker() {
  if (breakpoint.matches) {
